...
API REST simulada: JSON Server como backend falso
...
Verás un mensaje confirmando que los endpoints están disponibles:
Resources
http://localhost:3001/posts
http://localhost:3001/formacionD
http://localhost:3001/experiencia
